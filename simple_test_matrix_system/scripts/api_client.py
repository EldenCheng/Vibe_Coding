...
class APIClient:
    ...
    def analyze_image(self, image_path, prompt_text, max_tokens=20480, temperature=0.2, timeout=1200.0):
        """
        通过多模态API分析图片内容
    ...
    def analyze_text(self, prompt_text, max_tokens=20480, temperature=0.3, timeout=1200.0):
        """
        通过纯文本API分析内容
