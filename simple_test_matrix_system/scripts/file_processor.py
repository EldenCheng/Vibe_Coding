...
if __name__ == "__main__":
    # 简单测试
    test_file = r"C:\Users\automation\Vibe_Coding\create_test_case\2014_03-26_MiniZoomer_Flow_v10b.pdf"  # 替换为你的测试文件路径
    output_directory = r"C:\Users\automation\Vibe_Coding\create_test_case\output\images"
    success = process_file(test_file, output_directory)
    if success:
        print("文件处理成功！")
    else:
        print("文件处理失败！")